...
class CandidateRequirement(db.Model):
    ...
    #save created time in created_at colum
...
def coding_solutions():
    if request.method == 'POST':
        ...
        time_complexity, space_complexity, feedback = chatgpt("Longest Substring Without Repeating Characters Problem Statement: Given a string s, find the length of the longest substring without repeating characters.", solution_1)
